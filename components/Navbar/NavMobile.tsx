                ...
                {isOpen && (
                    ...
                    >
                        ...
                        <motion.div
                            ...
                            animate={{opacity: 1}}
                            exit={{opacity: 0}}
                            transition={{duration: 0.2,delay:0.5}} id={"contactus"} className={"lg:w-[90%] h-[40%] mx-auto rounded-2xl my-32 relative flex items-center justify-center"}>
                            <video src={"/output.webm"} className={"rounded-2xl w-[95%] mx-auto h-[90%] object-cover"} autoPlay loop
                                   muted playsInline/>
                            <div
