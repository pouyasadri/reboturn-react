...
const WhatWeDo: FC = () => {
    ...
    return (
        <div ref={targetRef} className="w-[90%] mx-auto relative h-[300vh] ">
            <div className={"sticky top-0 flex h-screen items-center"}>

                <motion.div style={{y: y3}} className="w-1/3  p-10">
                    <h1 className="text-6xl font-bold text-black mb-8">
                        Behind the scene of Reboturn</h1>
                    <p className="text-md text-black font-light mb-16">
                    ...
                    <button className="text-black text-md mt-5 relative overflow-hidden border border-black bg-black p-5 text-white text-xl rounded-xl transition-all before:absolute before:bottom-0 before:left-0 before:top-0 before:z-0 before:h-full before:w-0 before:bg-[#9ae1ef] before:transition-all before:duration-200 hover:text-black hover:border-[#9ae1ef] hover:before:left-0 hover:before:w-full"><span className="relative z-10">Discover more</span></button>

                </motion.div>
                <div
                    className={`${isScroll ? "w-screen" : "w-1/2"} absolute left-[50%] float-right text-black top-0 flex h-screen justify-center items-center`}>
